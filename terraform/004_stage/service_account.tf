resource "google_service_account" "web_stage" {
  account_id   = "web-stage"
...
resource "google_artifact_registry_repository_iam_member" "cr_sa" {
  ...
  member     = "serviceAccount:service-${data.google_project.web_stage.number}@serverless-robot-prod.iam.gserviceaccount.com"
